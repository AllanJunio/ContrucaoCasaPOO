	...
	public void exibeMenu() {
		...
		do {
			...
			case 0:
				...
				/*
				 * ArrayList - Vetor (que contém vários métodos em sua classe principal e começa
				 * vazio e pode ser preenchido com objetos e variáveis de vários tipos
				 */
				...
				/*
				 * Estruta for each. O objeto (no caso janela) irá percorrer o objeto casa para
				 * conseguir vizualizar a descrição e estado do objeto
				 */
			...
			case 1:
				/*
				 * Esta variável vai receber qual tipo de abertura o usuário deseja mover, por
				 * meio do método "solicitaTipoAbertura"
				 */
				...
				/*
				 * A variável listaDeAberturas irá receber o acesso na lista conforme escolhido.
				 * Portas / Janelas
				 */
				...
				if (posicao != -1) {
					...
					// Seta o estado no método mover abertura
